...
@constraint(model, 2x[10] + 3x[4] + 19y[5] <= 65)
...
@constraint(model, 5x[2]        -        x[6]        +        8x[7]        +        8x[10]        -        127y[11]        +        8x[1]        -        8x[3]        -        3x[4]        +        7x[8]        +        5x[9]  -        73y[12]        -        2x[5]        -        128y[13]        +        146y[14]        +        167y[15]        +        131y[16]        -        132y[17]                                                                
                               -        73y[18]        +        132y[19]        -        33y[20]        ==        0)
