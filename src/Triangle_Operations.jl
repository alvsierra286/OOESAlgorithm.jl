...
@inbounds function split_triangle_using_horizontal_cut(Priority_Queue::Vector{EOPriorQueue}, condition1::Bool, condition2::Bool, element1::OOESolution, element2::OOESolution, instance::MOOInstance, Feasible_Solution::OOESolution, Local_LB1::Float64, Local_LB2::Float64, Local_LB::Float64, Opt_Solution::OOESolution, GUB::Float64, Feasible_Solution_3::OOESolution, Feasible_Solution_4::OOESolution, Epsilon::Float64, stats)
	...
	if Slope < ((element1.obj_vals[3] + element2.obj_vals[3]) / 2) - Epsilon
		...
		if Feasible_Solution_4.fxopt #|| abs((Feasible_Solution_4.obj_vals[2] - element2.obj_vals[2])/element2.obj_vals[2]) < 1e-3
	...
	if Local_LB2 < GUB - Compute_Epsilon(GUB) && Point_Difference4(element1, Feasible_Solution_4) #&& Point_Difference3(element2, Feasible_Solution_4)
		insert_element_in_queue!(Priority_Queue, element1, Feasible_Solution_4, false, true, Local_LB2)
	end
	if Local_LB1 < GUB - Compute_Epsilon(GUB) && Point_Difference4(element2, Feasible_Solution_3) #&& Point_Difference3(element1, Feasible_Solution_3)
...
@inbounds function split_triangle_using_vertical_cut(Priority_Queue::Vector{EOPriorQueue}, condition1::Bool, condition2::Bool, element1::OOESolution, element2::OOESolution, instance::MOOInstance, Feasible_Solution::OOESolution, Local_LB1::Float64, Local_LB2::Float64, Local_LB::Float64, Opt_Solution::OOESolution, GUB::Float64, Feasible_Solution_3::OOESolution, Feasible_Solution_4::OOESolution, Epsilon::Float64, stats)
	...
	if Inverse_Slope < ((element1.obj_vals[2] + element2.obj_vals[2]) / 2) - Epsilon
		...
		if Feasible_Solution_4.fxopt #|| abs((Feasible_Solution_4.obj_vals[3] - element1.obj_vals[3])/element1.obj_vals[3]) < 1e-3
			Opt_Solution, GUB = Update_Global_Upper_Bound(Opt_Solution, Feasible_Solution_4, GUB)
		else
			Feasible_Solution_4, Opt_Solution, GUB, stats = LB_Finder_Point(instance, Feasible_Solution_4, Opt_Solution, GUB, false, stats)
			condition2 = true
	...
	if Local_LB2 < GUB - Compute_Epsilon(GUB) && Point_Difference4(element1, Feasible_Solution_3) #&& Point_Difference3(element2, Feasible_Solution_3)
		insert_element_in_queue!(Priority_Queue, element1, Feasible_Solution_3, false, false, Local_LB2)
	end
	if Local_LB1 < GUB - Compute_Epsilon(GUB) && Point_Difference4(element2, Feasible_Solution_4) #&& Point_Difference3(element1, Feasible_Solution_4)
...
################################
@inbounds function Triangle_Splitting_Algorithm(Priority_Queue::Vector{EOPriorQueue}, element::EOPriorQueue, Connection_Index::Bool, Partial_Connection::Bool, instance::MOOInstance, Opt_Solution::OOESolution, element1::OOESolution, element2::OOESolution, GUB::Float64, Epsilon::Float64, stats)
		...
		if (Upper_Bound_Condition == true)
			...
			if Point_Difference(Feasible_Solution, element1, element2)
				...
				if element.Direction == false
					Priority_Queue, Opt_Solution, GUB, stats = split_triangle_using_horizontal_cut(Priority_Queue, condition1, condition2, element1, element2, instance, Feasible_Solution, Local_LB1, Local_LB2, Local_LB, Opt_Solution, GUB, Feasible_Solution_3, Feasible_Solution_4, Epsilon, stats)	
				else
					Priority_Queue, Opt_Solution, GUB, stats = split_triangle_using_vertical_cut(Priority_Queue, condition1, condition2, element1, element2, instance, Feasible_Solution, Local_LB1, Local_LB2, Local_LB, Opt_Solution, GUB, Feasible_Solution_3, Feasible_Solution_4, Epsilon, stats)
				end
			end
